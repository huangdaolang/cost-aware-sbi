from torch import Tensor, nn, eye, ones
import torch
...
from cost_aware_posterior_estimator import CostAwarePosteriorEstimator


class CostAwareSNPE_C(CostAwarePosteriorEstimator):
    def __init__(
        self,
